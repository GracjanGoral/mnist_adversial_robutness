...
def run_attack(checkpoint, x_adv, epsilon, mean, variance, bool_gauss, bool_uniform):
  ...
  if l_inf > epsilon + 0.0001 and bool_uniform:
...
if __name__ == '__main__':
  ...
  if checkpoint is None:
    ...
    run_attack(checkpoint, x_adv, config['epsilon'], config['mean'], config['variance'], config['bool_gauss'], config['bool_uniform'])
